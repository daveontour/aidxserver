...
<#include "../basis/legid.ftl" parse=true>
		...
		<LegData>
			...
			<OperationalStatus RepeatIndex="2" CodeContext="1245">OP</OperationalStatus>
...
<#if linkAirline2??> <#include "../basis/assocFlightLeg2.ftl" parse=true> </#if>
			...
			<OperationTime CodeContext="9750" RepeatIndex="9" TimeType="EST" OperationQualifier="ONB">${sctonb}</OperationTime>
